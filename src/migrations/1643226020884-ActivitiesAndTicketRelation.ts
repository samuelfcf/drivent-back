...
export class ActivitiesAndTicketRelation1643226020884 implements MigrationInterface {
    name = "ActivitiesAndTicketRelation1643226020884"
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query("CREATE TABLE \"activities\" (\"id\" SERIAL NOT NULL, \"name\" text NOT NULL, \"date\" TIMESTAMP NOT NULL, \"vacancies\" integer NOT NULL, \"duration\" integer NOT NULL, \"localId\" integer, CONSTRAINT \"PK_7f4004429f731ffb9c88eb486a8\" PRIMARY KEY (\"id\"))");
      ...
      await queryRunner.query("ALTER TABLE \"activities\" ADD CONSTRAINT \"FK_e437c034807d19d981904c1ef56\" FOREIGN KEY (\"localId\") REFERENCES \"locals\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query("ALTER TABLE \"activities\" DROP CONSTRAINT \"FK_e437c034807d19d981904c1ef56\"");
